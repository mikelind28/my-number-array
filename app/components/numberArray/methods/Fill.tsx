...
export default function Fill() {
    ...
    function handleFill() {
        if (valueInputValueValid && startInputValueValid && endInputValue == undefined) {
        ...
        } else if (valueInputValueValid && startInputValueValid && endInputValue != undefined && endInputValueValid) {
            const returnValue = myNumberArray.fill(
                parseInt(valueInputValue),
                parseInt(startInputValue),
    ...
    return (
        <>
            ...
            <p>The <code>.fill()</code> array method takes three parameters: <code>value</code>, <code>start</code>, and <code>end</code>. This method will replace each array item from the <code>start</code> to <code>end</code> indices with <code>value</code>. This method mutates the original array and returns it.</p>
            <p>The <code>start</code> and <code>end</code> parameters are optional—if omitted, all elements until the end of the array will be copied.</p>
            ...
            <div className="flex flex-col gap-2 my-2 p-3 bg-gray-950/75 rounded-sm">
                ...
                >
                    <ButtonWrapper disabled={!valueInputValueValid || !startInputValueValid || !endInputValueValid}>
