...
export default function CopyWithin() {
    ...
    const [targetInputValueValid, setTargetInputValueValid] = useState<boolean>(false);
    ...
    function handleCopyWithin() {
        if (targetInputValueValid && startInputValueValid && endInputValue == undefined) {
        ...
        } else if (targetInputValueValid && startInputValueValid && endInputValue != undefined && endInputValueValid) {
            const returnValue = myNumberArray.copyWithin(
                parseInt(targetInputValue),
                parseInt(startInputValue),
    ...
    return (
        <>
            ...
            <p>The <code>.copyWithin()</code> array method takes three parameters: <code>target</code>, <code>start</code>, and <code>end</code>. Each is an integer that represents an index in the array. The <code>.copyWithin()</code> method copies the items from <code>start</code> up to (but not including) <code>end</code>, copies them to the <code>target</code> index, replacing the existing items. It modifies the original array and returns it.</p>
            <br/>
            ...
            <div className="flex flex-col gap-2 my-2 p-3 bg-gray-950/75 rounded-sm">
                ...
                >
                    <ButtonWrapper disabled={!targetInputValueValid || !startInputValueValid || !endInputValueValid}>
