...
export default function Push() {
    ...
    return (
        <>
            ...
            <p>
                The <code>.push()</code> array method takes one or more values as parameters, which are added to the end of the array. This method modifies the original array and returns its new length.
            </p>
