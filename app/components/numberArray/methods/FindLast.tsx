...
export default function FindLast() {
  ...
  useEffect(() => {
    ...
    if (selectValue === "<") {
      const result = myNumberArray.findLast(
  ...
  return (
    <>
      ...
      <p>
        The <code>.findLast()</code> array method takes a test function as a
        parameter. It returns the last item in the array that satisfies the test
        function. If no value satisfies the function, it returns{" "}
        <code>undefined</code>.
      </p>
